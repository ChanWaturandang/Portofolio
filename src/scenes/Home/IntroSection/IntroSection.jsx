      ...
      <div className={s.introduction}>
        <div className={s.introductionText}>
          ...
          <div className={s.description}>
            <p>
              I'm a React Native Developer and Web Designer. <br />
      ...
      <div className={s.introSocial}>
        ...
        <ul className={s.socialLinks}>
          <li className={s.socialLink}>
            <a
              href="https://github.com/ChanWaturandang"
              target="_blank"
              rel="noreferrer"
          ...
          <li className={s.socialLink}>
            <a
              href="https://web.facebook.com/cristiano.waturandang.7"
              target="_blank"
              rel="noreferrer"
              className={s.socialIcon}
              aria-label="facebook"
